    ...
    public class OwnerRepository : IOwnerRepository
    {
        ...
        public List<Owner> GetAllOwners()
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT Owner.*, Neighborhood.Name AS 'Neighborhood Name' FROM Owner LEFT JOIN Neighborhood ON NeighborhoodId = Neighborhood.Id
                    ";
        ...
        public Owner GetOwnerById(int id)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT o.Id AS 'Owner Id', o.Name AS 'Owner', Email, Address, Phone, 
                        ...
                        while (reader.Read())
                        {
                            ...
                            if (!reader.IsDBNull(reader.GetOrdinal("Dog Id")))
                            {
                                owner.Dogs.Add(new Dog
                                {
                                    ...
                                    Breed = reader.GetString(reader.GetOrdinal("Dog Breed"))
                                });
                            }
                        }
                            return owner;
